...
public class Resource {
    ...
    public static final int MY_OWN_R = 12;
    public static final int OTHER_OWN_R = 13;
    public static final int MONTH_REPORT_R = 14;
    public static final int USER_MNG = 15;
    public static final int DATA_INIT = 16;
    public static final int MY_PAID_EXPORT = 17;
    public static final int PAID_EXPORT = 18;
    public static final int CENSORED = 19;
    public static final int BACKUP = 20;
    public static final int GET_OTHERS_DATA = 21;
    public static final int IN_O = 22;
    public static final int OUT_O = 23;
